 ...
 */
class Magecom_First_Block_Catalog_Product_View extends Mage_Catalog_Block_Product_Abstract
{
    /**
    ...
    {
        $product_post = Mage::getModel('magecom_first/posts')->getCollection();
        $product_post->addFieldToFilter( 'product_id', $id );
        return $product_post;
    }
